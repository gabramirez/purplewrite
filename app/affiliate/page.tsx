      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-2">Get Paid to Talk About Natural Write</p>
              ...
              <div className="p-8 md:w-1/2 flex flex-col justify-center">
                ...
                <div className="space-y-4 mb-6">
                  <p className="text-gray-700">
                    Get <span className="text-green-500 font-medium">$1.50 for every 1,000 real views</span>
                  </p>
                  <p className="text-gray-700">
                    Minimum payout: <span className="text-green-500 font-medium">$15 for 10,000 views</span>
                  </p>
                  <p className="text-gray-700">
                    No cap: the more you grow, the more you earn!
                  </p>
                </div>
          ...
          <div className="max-w-4xl mx-auto mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
                ...
                <p className="text-gray-600">Make videos or posts about Natural Write</p>
              </div>
          ...
          <div className="max-w-4xl mx-auto mt-16">
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600">Click the "Join the Program" button and fill out the application form. Our team will review your application and get back to you within 48 hours.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <h3 className="font-medium mb-2">When do I get paid?</h3>
                <p className="text-gray-600">Payments are processed on the 1st of every month for the previous month's earnings, as long as you've reached the minimum payout threshold of $15.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <h3 className="font-medium mb-2">What type of content should I create?</h3>
                <p className="text-gray-600">You can create tutorials, reviews, or demonstrations of Natural Write. We'll provide you with guidelines and resources to help you create effective content.</p>
              </div>
            </div>
          </div>
